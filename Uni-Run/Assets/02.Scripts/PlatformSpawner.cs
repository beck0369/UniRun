...
public class PlatformSpawner : MonoBehaviour    // 발판을 생성하고 주기적으로 재배치하는 스크립트 
{
    ...
    public float timeBestSpawnMax = 2.25f;  // 다음 배치까지의 시간 간격 최댓값
    ...
    private void Start()    // 변수를 초기화하고 사용할 발판을 미리 생성
    {
    ...
    private void Update()// 순서를 돌아가며 주기적으로 발판을 배치
    {
        // 게임오버 상태에서는 동작하지 않음
        ...
        if (Time.time >= lastSpawnTime + timeBetSpawn)
        {
            ...
            timeBetSpawn = Random.Range(timeBetSpawnMin, timeBestSpawnMax);
